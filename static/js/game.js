...
function up(){
  cube.rotateSclice('y',2,'counterclockwise');

}

function up_inv(){
  cube.rotateSclice('y',2,'clockwise');

}

function down(){
  cube.rotateSclice('y',0,'clockwise');

}

function down_inv(){
  cube.rotateSclice('y',0,'counterclockwise');

}

function left(){
  cube.rotateSclice('x',0,'clockwise');

}

function left_inv(){
  cube.rotateSclice('x',0,'counterclockwise');

}

function right(){
  cube.rotateSclice('x',2,'counterclockwise');

}

function right_inv(){
  cube.rotateSclice('x',2,'clockwise');

}

function front(){
  cube.rotateSclice('z',2,'counterclockwise');

}

function front_inv(){
  cube.rotateSclice('z',2,'clockwise');

}

function back(){
  cube.rotateSclice('z',0,'clockwise');

}

function back_inv(){
  cube.rotateSclice('z',0,'counterclockwise');
